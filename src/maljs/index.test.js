...
describe("maljs", () => {
  ...
  describe("atom", () => {
    ...
    it("rest", () => {
      assert.equal(REP(`(rest (list))`), `()`);
      assert.equal(REP(`(rest nil)`), `()`);
      assert.equal(REP(`(rest (list 10))`), `()`);
      assert.equal(REP(`(rest (list 10 11 12))`), `(11 12)`);
      assert.equal(REP(`(rest (cons 10 (list 11 12)))`), `(11 12)`);
    });
